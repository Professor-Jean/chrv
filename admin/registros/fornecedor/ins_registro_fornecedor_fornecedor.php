                        ...
                        $msg = msgGeral('4','','telefone');
                          ...
                          $msg = msgGeral('4','','email');
                            ...
                            $msg = msgGeral('4','','representante');
                              ...
                              $sql_sel_fornecedor = "SELECT * FROM fornecedores WHERE nome='".$p_nomefant."'";
                              ...
                              if ($sql_sel_fornecedor_preparado->rowCount()==0) {
                                ...
                                $sql_ins_fornecedor_resultado = adicionar($tabela, $dados);

                                if ($sql_ins_fornecedor_resultado) {
                                  $msg_aviso = "Confirmação";
                                  $msg       = msgGeral('1', 'efetuado', 'fornecedor');
                                  $cor       = "confirmacao";
                                }else {
                                  $msg = msgGeral('2', 'registro', 'fornecedor');
                                }
                              }else {
                                $msg = msgGeral('8','','');
                              }
