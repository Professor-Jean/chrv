  ...
  <h1 class="titulo_corpo" align="center"> Aviso </h1>
    <div class="mensagem_aviso">
                  ...
                  $msg = msgGeral('4','','Motivo');
                    ...
                    $msg = msgGeral('4','','Desconto');
                      ...
                      $msg = msgGeral('4','','Data');
                        ...
                        $sql_sel_saidas_novos = "SELECT * FROM entradas WHERE id='".$p_lote."' AND produtos_id='".$p_id_produto."' AND esgotada='0' AND tipo='PU'";

                        $sql_sel_saidas_preparado = selecionar($sql_sel_saidas_novos);

                        if ($sql_sel_saidas_preparado->rowCount()>0) {

                          $sql_sel_saidas_dados = $sql_sel_saidas_preparado->fetch();

                          $atual = $sql_sel_saidas_dados['quantidade'] - $p_quantidade;
                          ...
                          if ($atual>=0){
                            ...
                            $condicao = "id='".$p_lote."' AND produtos_id='".$p_id_produto."' AND esgotada='0' AND tipo='PU'";
      ...
      <!--class erro e sucesso -->
          ...
          <a class="icone" href="?folder=movimentacoes/saidas/usados/&file=mov_sai_usados_usados&ext=php"><i class="fa fa-reply" aria-hidden="true"></i>Voltar</a>
        </div>
    </div>
