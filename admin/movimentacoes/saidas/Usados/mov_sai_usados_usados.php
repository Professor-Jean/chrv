<div class="ajustavel">
  <h1 class="titulo_corpo" align="center">Saída de Estoque de Produtos Usados</h1>
  <a href='?folder=movimentacoes/saidas/novos/&file=mov_sai_novos_novos&ext=php'><button  class="tipos">Produtos Novos</button></a>
  <a href='?folder=movimentacoes/saidas/usados/&file=mov_sai_usados_usados&ext=php'><button style="background-color: #666;" class="tipos">Produtos Usados</button></a>
  <hr/ class="limpa_float">
  <div style="margin-bottom: 2%; margin-top: 1.5%;">
    <form name=frmCadSaidasUsados onsubmit="" method="post" action="?folder=movimentacoes/saidas/usados/&file=ins_sai_ent_usados_usados&ext=php">
      <table class="tabela_registro">
        <tr>
          <td class="td_registro">Marca:</td>
          <td class="td_registro">
            <select class="input_registro" id="marca" name="selmarca" onChange="mostraProdutosSaiUsados()" required>
        ...
        <tr>
          ...
          <td class="td_registro">
            <select class="input_registro" id="categoria" name="selcategoria" onChange="mostraProdutosSaiUsados()" required>
            <option value="">Escolha...</option>
            <?php
        ...
        <tr>
          ...
          <td class="td_registro">
            <select class="input_registro" id="produto" name="selproduto" onChange="mostraProdutosSaiLoteUsados()" required>
              <option value="">Escolha...</option>
            </select>
          </td>
        <tr>
          <td>Lote:</td>
          <td class="td_registro">
            <select class="input_registro" id="lote" name="sellote" onChange="mostraProdutosSaiVendaUsados()"  required>
              <option value="">Escolha...</option>
            </select>
          </td>
        </tr>
