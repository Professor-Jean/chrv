<div class="ajustavel">
  ...
  <a href="#"><button style="background-color: #666;" class="tipos">24 meses</button></a>
  <hr class="limpa_float"/>

  <?php

  $data_atual = date('Y-m-d');
  $data_seis_atras = date('Y-m-01', strtotime("-24 Months"));
  ...
  switch ($data['month']) {
    ...
    var valor13 = "<?php echo $valor_venda["13"] ?>";
    var valor14 = "<?php echo $valor_venda["14"] ?>";
    var valor15 = "<?php echo $valor_venda["15"] ?>";
    var valor16 = "<?php echo $valor_venda["16"] ?>";
    var valor17 = "<?php echo $valor_venda["17"] ?>";
    var valor18 = "<?php echo $valor_venda["18"] ?>";
    var valor19 = "<?php echo $valor_venda["19"] ?>";
    var valor20 = "<?php echo $valor_venda["20"] ?>";
    var valor21 = "<?php echo $valor_venda["21"] ?>";
    var valor22 = "<?php echo $valor_venda["22"] ?>";
    var valor23 = "<?php echo $valor_venda["23"] ?>";
    var valor24 = "<?php echo $valor_venda["24"] ?>";
    ...
    var myChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: [mes1, mes2, mes3, mes4, mes5, mes6, mes7, mes8, mes9, mes10, mes11, mes12, mes1, mes2, mes3, mes4, mes5, mes6, mes7, mes8, mes9, mes10, mes11, mes12, mes1],
            datasets: [{
                label: 'Preço',
                data: [valor0, valor1, valor2, valor3, valor4, valor5, valor6, valor7, valor8, valor9, valor10, valor11, valor12, valor13, valor14, valor15, valor16, valor17, valor18, valor19, valor20, valor21, valor22, valor23, valor24],
                backgroundColor: [
